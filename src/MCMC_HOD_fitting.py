...
def model(theta):
    ...
    if len(glob(name_par)) == 1:
        ...
        G1 = HOD_mock(theta,haloes,weights_haloes)
...
mass_def_range = np.array([[12.9,13.8],
                        [13.8,14.6],
                        [12.9,13.9],
                        [0.3,0.7],
                        [0.8,1.3]])
...
def main(p0,nwalkers,niter,ndim,lnprob,data):
    #print('Running mcmc...\n')
    st = np.array([0.1,0.1,0.1,0.04,0.04])/3#array with stepsize for the parameter space
    cov_vec =  st**2
